...
_Herbert P. Susmann, Alec McLean, Iván Díaz_

This repository includes replication materials for the manuscript _Non-overlap Average Treatment Effect Bounds_.

The simulation study materials, including instructions for replicating the simulation study and associated tables, are found in the `simulation_study_1` folder. 
